...
echo ""
echo "⚠️  IMPORTANT: Aegis replaces Hermes's backend setting!"
echo "   Your 'backend: local/docker/ssh' config is now ignored."
echo "   Aegis provides its own security layer (Tier 1 or 2)."
echo ""
